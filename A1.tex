...
\input{figures/tabla_balance.tex}
...
\input{figures/resultados_d.tex}
...
\begin{equation}
\log(\text{ingreso semanal}_i) = \alpha + \beta \, \text{anios\_esc}_i + \epsilon_i
\end{equation}
...
\begin{equation}
\overline{\log(\text{ingreso semanal})}_e = \alpha + \beta \, \text{anios\_esc}_e + u_e, \quad \text{ponderado por } n_e
\end{equation}

\input{figures/tabla_reg_fec.tex}
